    ...
    return (
        <div className="py-24 sm:py-32">
            <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                <p className="mx-auto mt-2 max-w-lg text-center text-4xl font-semibold tracking-tight text-balance sm:text-5xl">Everything
                    you need to deploy your app</p>
                <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
                    <div className="relative max-lg:row-start-1">
                        <div className="absolute inset-px rounded-lg  max-lg:rounded-t-4xl"></div>
                        <div
                            ...
                            <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                                ...
                                <p className="mt-2 max-w-lg text-sm/6  max-lg:text-center">Lorem ipsum,
                    ...
                    <div className="relative max-lg:row-start-2">
                        ...
                        <div
                            ...
                            <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                                ...
                                <p className="mt-2 max-w-lg text-sm/6  max-lg:text-center">Morbi viverra
